...
ggplot(dat,aes(x=YearC)) + geom_bar() + theme_bw() + labs(x="Year",y="Articles")
ggsave("Figures/PerYear.jpeg",height=4,width=6)
```
...
dat$Focus<-factor(dat$Focus,level=c("Measurement","Counting","Tracking","Identity"))
...
ggsave("Figures/Focus_Taxa.jpeg",height=4,width=9)
```
